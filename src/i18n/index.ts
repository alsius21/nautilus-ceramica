...
const ca = {
	...
	'work.bishop.description': 'Peça del projecte d’escacs modelada al taller Hoji. L’alfil negre s’aixeca amb una verticalitat tensa, com un moviment a punt de fer-se.',
	'work.bishop.alt': 'Alfil negre del projecte d’escacs, al taller Hoji',
	'work.queen.title': 'Dama',
	'work.queen.description': 'La dama del projecte d’escacs, modelada al taller Hoji. Un volum contingut que guarda el pes de tot el joc en una sola peça.',
...
const es: Record<keyof typeof ca, string> = {
	...
	'work.bishop.description': 'Pieza del proyecto de ajedrez modelada en el taller Hoji. El alfil negro se alza con una verticalidad tensa, como un movimiento a punto de hacerse.',
	'work.bishop.alt': 'Alfil negro del proyecto de ajedrez, en el taller Hoji',
	'work.queen.title': 'Dama',
	'work.queen.description': 'La dama del proyecto de ajedrez, modelada en el taller Hoji. Un volumen contenido que guarda el peso de todo el juego en una sola pieza.',
...
const en: Record<keyof typeof ca, string> = {
	...
	'work.bishop.description': 'A piece from the chess project, modelled at the Hoji workshop. The black bishop rises with a tense verticality, like a move about to happen.',
	'work.bishop.alt': 'Black bishop from the chess project, at the Hoji workshop',
	'work.queen.title': 'Queen',
	'work.queen.description': 'The queen of the chess project, modelled at the Hoji workshop. A contained volume that holds the weight of the whole game in a single piece.',
