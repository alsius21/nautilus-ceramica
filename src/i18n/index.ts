...
const ca = {
	...
	'work.jarron.description': 'Un gerro aixecat a mà, amb un esmalt que recull la llum del taller i la deixa córrer per la superfície.',
	'work.jarron-1.alt': 'Gerro de ceràmica treballat a mà al taller Hoji',
	'work.jarron-2.alt': 'Detall de l’esmalt del gerro de ceràmica',
	'work.jarron-3.alt': 'Gerro de ceràmica vist des d’un altre angle',
...
const es: Record<keyof typeof ca, string> = {
	...
	'work.jarron.description': 'Un jarrón levantado a mano, con un esmalte que recoge la luz del taller y la deja correr por la superficie.',
	'work.jarron-1.alt': 'Jarrón de cerámica trabajado a mano en el taller Hoji',
	'work.jarron-2.alt': 'Detalle del esmalte del jarrón de cerámica',
	'work.jarron-3.alt': 'Jarrón de cerámica visto desde otro ángulo',
	'exhibit.argilla-2026.venue': 'Argentona',
	'exhibit.argilla-2026.title': 'Argillà',
...
const en: Record<keyof typeof ca, string> = {
	...
	'work.jarron.description': 'A vase raised by hand, with a glaze that catches the light of the workshop and lets it run across the surface.',
	'work.jarron-1.alt': 'Handmade ceramic vase in the Hoji workshop',
	'work.jarron-2.alt': 'Detail of the glaze on the ceramic vase',
	'work.jarron-3.alt': 'Ceramic vase seen from another angle',
	'exhibit.argilla-2026.venue': 'Argentona',
	'exhibit.argilla-2026.title': 'Argillà',
